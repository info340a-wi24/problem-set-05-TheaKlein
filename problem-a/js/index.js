...
let lengthRatio = (newMotto.length/mottoLength) * 100;
...
numbers.sort((a,b) => a - b); //sorting!! ascending
...
/*For me, it shows up as undefined. The new triangle values are accompanied
by a hypotenuse value after I manually add it in.*/
